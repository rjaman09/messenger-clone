                    ...
                    <div className="flex h-full flex-col overflow-y-scroll bg-white py-6 shadow-xl">
                      ...
                      <div className="relative mt-6 flex-1 px-4 sm:px-6">
                        <div className="flex flex-col items-center">
                          ...
                          <div className="tracking-wide text-sm text-gray-500">{statusText}</div>
                          <div className="flex gap-10 my-8">
                            <div onClick={() => setConfirmOpen(true)} className="flex flex-col gap-3 items-center cursor-pointer">
                              <div className="w-10 h-10 bg-neutral-100 rounded-full flex items-center justify-center hover:opacity-60">
                                <IoTrash size={20} className="text-red-600" />
                              </div>
                              <div className="text-sm font-light text-neutral-600 tracking-wide">Delete</div>
                            </div>
                          </div>
                          ...
                          <div className="w-full pb-5 pt-5 sm:px-0 sm:pt-0">
                            <dl className="space-y-8 px-4 sm:space-y-6 sm:px-6">
                              ...
                              {data.isGroup && (
                                <div>
                                  <dt className="text-base font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">Emails</dt>
                              ...
                              {!data.isGroup && (
                                <div>
                                  <dt className="text-sm md:text-md tracking-wide font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">Email</dt>
                                  <dd className="mt-1 text-sm tracking-wide text-gray-900 sm:col-span-2">
                                    {otherUser.email}
                                  </dd>
                                </div>
                              )}
                              ...
                              {!data.isGroup && (
                                <>
                                  <hr />
                                  <div>
                                    <dt className="text-sm md:text-md tracking-wide font-medium text-gray-500 sm:w-40 sm:flex-shrink-0">Joined</dt>
                                    <dd className="mt-1 text-sm tracking-wide text-gray-900 sm:col-span-2">
